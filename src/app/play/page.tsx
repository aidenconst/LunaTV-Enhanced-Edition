...
function PlayPageClient() {
          ...
          customType: {
            m3u8: function (video: HTMLVideoElement, url: string) {
              ...
              const hls = new Hls({
                ...
                lowLatencyMode: !isMobile, // 🔄 从前面移过来保留
                ...
                maxMaxBufferLength: isMobile ? (localIsIOS13 ? 60 : 120) : 600,
              ...
              hls.on(Hls.Events.ERROR, function (event: any, data: any) {
                ...
                if (data.details === 'bufferStalledError') {
                  ...
                  try {
                    ...
                    console.warn('recoverMediaError 失败:', e);
                    // 如果恢复失败，重新加载当前播放位置
  ...
  return (
    <>
      <PageLayout activePath='/play'>
        <div className='flex flex-col gap-3 py-4 px-5 lg:px-12 2xl:px-20 pb-40 md:pb-safe-bottom'>
          {/* 第一行：影片标题 */}
          <div className='py-1'>
