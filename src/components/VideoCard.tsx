...
const VideoCard = forwardRef<VideoCardHandle, VideoCardProps>(
  function VideoCard(
    ...
    return (
      <>
        <div
          className='@container group relative w-full rounded-lg bg-transparent cursor-pointer transition-all duration-300 ease-in-out hover:scale-[1.01] hover:z-30 hover:shadow-2xl'
          onClick={handleClick}
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                className='block text-xs @[140px]:text-sm font-bold line-clamp-2 text-gray-900 dark:text-gray-100 leading-tight min-h-[2.5rem] transition-all duration-300 ease-in-out group-hover:scale-[1.02] peer relative z-10 group-hover:bg-linear-to-r group-hover:from-green-600 group-hover:via-emerald-600 group-hover:to-teal-600 dark:group-hover:from-green-400 dark:group-hover:via-emerald-400 dark:group-hover:to-teal-600 group-hover:bg-clip-text group-hover:text-transparent group-hover:drop-shadow-[0_2px_8px_rgba(16,185,129,0.3)]'
                style={
                  {
                    WebkitUserSelect: 'none',
                    userSelect: 'none',
            ...
            {config.showSourceName &&
              ...
              (() => {
                ...
                return (
                  <div
                    className='flex items-center justify-center mt-2 mb-2.5'
                    style={
                      {
                        WebkitUserSelect: 'none',
                        userSelect: 'none',
                  ...
                  >
                    <span
                      className={`relative inline-flex items-center gap-1.5 px-3 py-1 text-xs font-medium rounded-full border border-gray-300/60 dark:border-gray-600/60 text-gray-600 dark:text-gray-400 transition-all duration-300 ease-out overflow-hidden group-hover:shadow-md group-hover:scale-102 ${colorClasses}`}
                      style={
                        {
                          WebkitUserSelect: 'none',
                          userSelect: 'none',
