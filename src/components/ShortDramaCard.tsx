...
function ShortDramaCard({
  ...
  return (
    <>
      <div
        className={`group relative ${className} transition-all duration-300 ease-in-out hover:scale-[1.01] hover:z-30 hover:shadow-2xl cursor-pointer rounded-lg overflow-hidden`}
        onClick={handleClick}
      ...
      >
        ...
        <div className='mt-2 px-2 space-y-1.5'>
          <h3 className='block text-xs @[140px]:text-sm font-bold line-clamp-2 text-gray-900 dark:text-gray-100 leading-tight min-h-[2.5rem] transition-all duration-300 ease-in-out group-hover:scale-[1.02] peer relative z-10 group-hover:drop-shadow-[0_2px_8px_rgba(16,185,129,0.3)]'>
            {drama.name}
          </h3>
